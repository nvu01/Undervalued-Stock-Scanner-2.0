...
| Metric               | Preferred z-score direction | Interpretation |
|----------------------|---|---|
| P/FCF, P/B, A/E, P/E | Negative | Lower valuation relative to peers |
| ROE, ROA             | Positive | Higher profitability relative to peers |
...
**For detailed instructions, refer to `Instructions.pdf`.**
